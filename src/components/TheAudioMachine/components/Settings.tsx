...
import {Layer, RootState, setBpm, setLayerPan, setLayerVolume, setVolume} from '../../../redux'

import {uploadSample} from '../logic'

import {GLOBAL_SETTINGS, LAYER_SETTINGS, SETTINGS, SLIDER, UPLOAD_SAMPLE} from '../styled'
                            ...
                            <UPLOAD_SAMPLE layerId={layer.id}>
                                <label htmlFor='sample'>
                                    <input type="file" id='sample'
                                           onChange={e => e.target.files && uploadSample(e.target.files[0], layer.id)}/>
                                </label>
                            </UPLOAD_SAMPLE>
                        </LAYER_SETTINGS>
                        : null
