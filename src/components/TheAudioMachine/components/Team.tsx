        ...
        <TEAM>
            ...
            <TEAM_CONTENT>
                ...
                <TEAM_TEXT>
                    ...
                    <TEAM_DEPARTMENT>Coding</TEAM_DEPARTMENT>
                    <TEAM_LINK>
                        <a href={"https://www.linkedin.com/in/steffen-marquardt-2a460a166/"}>
                            <i className="fab fa-linkedin"/>
                        </a>
                        <a href={"https://open.spotify.com/artist/3HSImMBGEJ031Rl2ZRNmTF"}>
                            <i className="fab fa-spotify"/>
                        </a>
                        <a href={"https://www.instagram.com/evenbeats/"}>
                ...
                <TEAM_TEXT>
                    ...
                    <TEAM_DEPARTMENT>Coding</TEAM_DEPARTMENT>
                    <TEAM_LINK>
                        <a href={"https://de.linkedin.com/in/jakob-getz-8a8082178/en-us"}>
                            <i className="fab fa-linkedin"/>
                        </a>
                        <a href={"https://soundcloud.com/howtotellastory"}>
